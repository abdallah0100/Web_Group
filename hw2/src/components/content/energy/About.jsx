    ...
    <div className="min-h-screen bg-gradient-to-r from-[#003C43] to-[#77B0AA] relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-between min-h-screen p-4 bg-white bg-opacity-75 relative z-10 dark:bg-gray-800 dark:bg-opacity-75">
        <header className="text-center my-8">
          <h1 className="text-4xl font-bold text-[#003C43] dark:text-white">About Us</h1>
        </header>
        <main className="max-w-6xl w-full p-8 bg-white bg-opacity-90 dark:bg-gray-800 dark:bg-opacity-90 rounded-lg shadow-lg">
          ...
          <section className="mb-12 text-center">
            <h2 className="text-3xl font-semibold text-[#003C43] dark:text-[#a0d8d8] mb-4">Welcome to E.C.M!</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-semibold text-[#003C43] dark:text-[#a0d8d8] mb-4 text-center">Key Features</h2>
            <ul className="list-disc pl-5 text-[#003C43] dark:text-white">
          ...
          {/* Our Mission */}
          <section className="mb-12 text-center">
            <h2 className="text-3xl font-semibold text-[#003C43] dark:text-[#a0d8d8] mb-4">Our Mission</h2>
            <p className="text-lg text-[#003C43] dark:text-white">
          ...
          {/* Our Team */}
          <section className="mb-12 text-center">
            <h2 className="text-3xl font-semibold text-[#003C43] dark:text-[#a0d8d8] mb-4">Meet Our Team</h2>
            <p className="text-lg text-[#003C43] dark:text-white">
            ...
            <p className="text-lg text-[#003C43] dark:text-white mt-4">
              Our team members are:
            </p>
            <ul className="text-lg text-[#003C43] dark:text-white mt-4">
            ...
            <p className="text-lg text-[#003C43] dark:text-white mt-8">
          ...
          {/* Contact Information */}
          <section className="pt-6 rounded-lg shadow-lg p-6 bg-[#77B0AA] bg-opacity-90 dark:bg-[#003C43] dark:text-white">
